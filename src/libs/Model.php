...
class Model 
{
    ...
    {
        global $application;
        $this->currentController = !empty($application) ? ucfirst($application->request["controller"]) : null;
        $this->request = !empty($application) ? $application->request : null;
        $this->currentAction = !empty($application) ? $application->request['action'] : null;
